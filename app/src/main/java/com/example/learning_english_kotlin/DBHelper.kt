...
class DBHelper(context: Context?) : SQLiteOpenHelper(context, DATABASE_NAME, null, VERSION) {
    ...
    private fun updateMyDatabase(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        if (oldVersion < 1) {
            ...
            insertLesson(db, "папа", "father", "Семья и друзья", R.drawable.father)
            ...
            insertLesson(db, "дедушка", "grandfather", "Семья и друзья", R.drawable.grandfather)
            insertLesson(db, "родители", "parents", "Семья и друзья", R.drawable.parents)
            insertLesson(db, "друзья", "friends", "Семья и друзья", R.drawable.friends)
            ...
            insertLesson(db, "щека", "cheek", "Части тела", R.drawable.cheek)
            ...
            insertLesson(db, "волосы", "hair", "Части тела", R.drawable.hair)
            ...
            insertLesson(db, "свитер", "sweater", "Одежда", R.drawable.sweater)
            insertLesson(db, "ботинки", "shoes", "Одежда", R.drawable.shoes)
            ...
            insertLesson(db, "черный", "черный", "Цвета", R.drawable.black)
            ...
            insertLesson(db, "фрукты", "fruits", "Фрукты и овощи", R.drawable.fruits)
            ...
            insertLesson(db, "пирожное", "cake", "Еда", R.drawable.cake)
            ...
            insertLesson(db, "курица", "chicken", "Еда", R.drawable.chicken)
            ...
            insertLesson(db, "калькулятор", "calculator", "Школа", R.drawable.calculator)
            insertLesson(db, "карта", "map", "Школа", R.drawable.map)
            insertLesson(db, "ластик", "eraser", "Школа", R.drawable.eraser)
            ...
            insertLesson(db, "жара", "heat", "Погода и природа", R.drawable.heat)
            insertLesson(db, "холодно", "cold", "Погода и природа", R.drawable.cold)
            ...
            insertLesson(db, "гора", "mountain", "Погода и природа", R.drawable.mountain)
